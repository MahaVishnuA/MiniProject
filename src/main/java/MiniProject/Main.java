...
public class Main {
	...
	public List<String> getSuggestions() throws IOException{
		...
		try{
			...
			FileHandler.copy(screenshot1,new File("C:\\Users\\2318459\\eclipse-workspace\\Vishnu\\src\\main\\java\\MiniProject\\ScreenShots\\SearchOptionsScreenShot.png"));
			}
		catch(Exception e) {
			e.printStackTrace();
		}
	...
	public String findResults() {
			...
			try{
				...
				FileHandler.copy(screenshot2,new File("C:\\Users\\2318459\\eclipse-workspace\\Vishnu\\src\\main\\java\\MiniProject\\ScreenShots\\OptionsScreenShot.png"));
				}
			catch(Exception e) {
	...
	public String newsClick() {
		...
		//driver.findElement(By.cssSelector("#bqHHPb > div > div > div > div.IUOThf > div:nth-child(1) > a")).click();
		...
		try{
			...
			FileHandler.copy(screenshot3,new File("C:\\Users\\2318459\\eclipse-workspace\\Vishnu\\src\\main\\java\\MiniProject\\ScreenShots\\News.png"));
			}
		catch(Exception e) {
			System.out.println(e);
		}
	...
	public void imagesClick() {
		...
		//driver.findElement(By.cssSelector("#cnt > div.rfiSsc > div > div > div.xhjkHe > div.TrmO7 > div > a:nth-child(5)")).click();
		driver.findElement(By.linkText("Images")).click();
		//take a screenshot
		try{
			File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
			FileHandler.copy(screenshot4,new File("C:\\Users\\2318459\\eclipse-workspace\\Vishnu\\src\\main\\java\\MiniProject\\ScreenShots\\Images.png"));
			}
		catch(Exception e) {
			System.out.println(e);
		}
	...
	public String videosClick() {
		...
		//driver.findElement(By.cssSelector("#yDmH0d > div.T1diZc.KWE8qe > c-wiz > div.ndYZfc > div > div.tAcEof > div.O850f > div > div > a:nth-child(6)")).click();
		...
		try{
			...
			FileHandler.copy(screenshot5,new File("C:\\Users\\2318459\\eclipse-workspace\\Vishnu\\src\\main\\java\\MiniProject\\ScreenShots\\Videos.png"));
			}
		catch(Exception e) {
			System.out.println(e);
		}
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			PrintStream ps =new PrintStream(new File("C:\\Users\\2318459\\eclipse-workspace\\Vishnu\\src\\main\\java\\MiniProject\\result.txt"));
			System.setOut(ps);
			for(String ed:linkS) {
				ps.print(ed);
				System.out.println();
